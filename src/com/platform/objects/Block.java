...
public class Block extends GameObject{
	...
	public void render(Graphics g) {
		if(type==0) { 
			g.drawImage(tex.block[0], (int)x, (int)y, null);						// Load tile texture
		}
		if(type==1) { 
			g.drawImage(tex.block[1], (int)x, (int)y, null);						// Load tile texture
		}
		if(type==2) { 
			g.drawImage(tex.block[2], (int)x, (int)y, null);						// Load can texture
		}
		if(type==3) { 
			g.drawImage(tex.block[3], (int)x, (int)y, null);						// Load can texture
		}
